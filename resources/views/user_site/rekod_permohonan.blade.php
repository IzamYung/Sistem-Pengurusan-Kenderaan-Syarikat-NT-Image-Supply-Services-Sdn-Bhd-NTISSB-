...
<div class="max-w-6xl mx-auto mt-10 mb-20 px-4">
    ...
    {{-- FILTER STATUS (DIUBAH KE KANAN MACAM ADMIN) --}}
...
<div id="modalPermohonan" 
    ...
    <div data-modal-card
         class="bg-white w-full max-w-2xl rounded-2xl shadow-2xl 
                transform scale-95 opacity-0 transition-all duration-200 overflow-hidden max-h-[90vh] flex flex-col">
        ...
        <div class="p-8 overflow-y-auto custom-scrollbar space-y-8">
            ...
            {{-- SEKSYEN 2: ULASAN ADMIN (Dikekalkan untuk maklum balas) --}}
            ...
            <div>
                ...
                {{-- Container Grid untuk Gambar --}}
                <div id="m-lampiran" class="grid grid-cols-2 md:grid-cols-3 gap-4">
                    {{-- Gambar lampiran akan dipaparkan di sini oleh JS --}}
                </div>
